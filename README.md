...
At Authory Technology S.L., we're focused on the writing process. By capturing key event data (also known by the scary euphemism "key logging"), we can make new opportunities for teaching, learning, and research in a low-cost, low-effort way, all in the existing workflows of your course and site.
...
```
git clone https://github.com/authory-tech/moodle-tinymce_authory_tech.git authory_tech
```
