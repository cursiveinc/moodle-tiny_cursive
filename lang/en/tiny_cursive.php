...
$string['privacy:metadata:database:tiny_cursive:content'] = "User keystroke date for generating analytics report";
...
$string['quality_access_des'] = 'Activate or Deactivate these advanced configuration features.';
