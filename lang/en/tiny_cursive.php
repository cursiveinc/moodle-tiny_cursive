...
$string['analytics_guidance_label'] = 'What to look for';
...
$string['authorship_guidance'] = 'Scores below 50% suggest the typing behavior differs significantly from the student\'s established profile.';
...
$string['effort_ratio_guidance'] = 'Values below 100%, which indicate the student likely pasted content from an external source.';
...
$string['showguidance_help'] = 'Show "what to look for" notes under each metric. This preference is saved and applies to all analytics popups.';
$string['stats'] = 'Stats';
...
$string['time_writing_guidance'] = 'Very short active writing times relative to word count, suggesting the work was drafted elsewhere.';
...
$string['total_words_guidance'] = 'Large gaps between this count and the final submission, indicating unverified or pasted blocks.';
...
$string['words_per_minute_guidance'] = 'Consistent speeds above 100 WPM, which may indicate rehearsed typing or non-human input.';
$string['wpm'] = "WPM";
