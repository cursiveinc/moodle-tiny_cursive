...
$string['name'] = "Name";
$string['new_admin_desc'] = "Allows administrators to customize the notification text and link shown when enabling Cursive on the course settings page. Both the message and URL can be edited via the Language customization page.";
