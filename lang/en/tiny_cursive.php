...
$string['notice_enabled_desc'] = 'Users must acknowledge the notice before the Cursive editor loads. There is no decline option: a user who does not acknowledge must pick another text editor in their preferences, so keep at least one other editor enabled. Turning this on mid-term gates every existing user immediately. Consent itself, withdrawals, objections and under-18 questions are handled by your institution, not Cursive. See the <a href="{$a->reporturl}">acknowledgement report</a> for who has and has not acknowledged.';
...
$string['notice_heading_desc'] = 'Require users to acknowledge a fixed notice about writing-process and biometric (keystroke) data collection before the Cursive editor loads. Each acknowledgement is logged with the date and the exact wording shown. The wording is translated and cannot be edited here.';
$string['notice_nofallback_warning'] = 'Cursive is the only enabled text editor on this site, so users who do not acknowledge cannot enter written work anywhere. Enable another editor under <a href="{$a->manageurl}">Manage editors</a> or leave gating off. The <a href="{$a->reporturl}">acknowledgement report</a> shows who is affected.';
...
$string['notice_para3'] = 'Further information about the processing of your personal data can be found in <a href="{$a->privacyurl}" target="_blank" rel="noopener">your institution\'s privacy notice <span class="sr-only visually-hidden">(opens in a new window)</span></a>.';
...
$string['notice_retentionperiod_default'] = 'Default: keep indefinitely';
$string['notice_retentionperiod_desc'] = 'How long acknowledgement records are kept. 0 keeps them indefinitely, which is recommended: they are your evidence that users were informed, and erasure requests never remove them. Otherwise a daily task permanently deletes older records and their unreferenced wording snapshots.';
