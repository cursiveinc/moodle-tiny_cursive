...
$string['cursive:fail'] = "Cursive disable failed.";
$string['cursive:status'] = "Something went wrong while disabling Cursive.";
$string['cursive:succ'] = "Cursive disable successful.";
...
$string['cursivedisable'] = "Disable Cursive Globally";
$string['cursivedisable_des'] = "This setting will disable Cursive for all courses. You can re-enable it individually through each course's settings.";
