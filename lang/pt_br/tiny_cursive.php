...
$string['authorship_guidance'] = 'Procure por autoria verificada nas sessões de um aluno com 100 palavras ou mais. Uma contagem baixa de palavras, a primeira submissão ou uma divergência rara não são prova de desonestidade.';
...
$string['backspace_guidance'] = 'Taxas abaixo de 3%. Primeiros rascunhos "perfeitos" com quase nenhuma edição costumam ser sinais de cópia manual.';
...
$string['effort_ratio_guidance'] = 'Valores abaixo de 100%, que indicam que o aluno provavelmente colou conteúdo de uma fonte externa.';
...
$string['event_notice_acknowledged'] = 'Aviso de transparência de dados aceito';
...
$string['notice_consent_button'] = 'Dou meu consentimento';
$string['notice_disabled'] = 'O aviso de transparência de dados não está ativado neste site, pelo que não é possível registrar nenhuma aceitação.';
$string['notice_enabled'] = 'Exigir a aceitação do aviso';
$string['notice_enabled_desc'] = 'Os usuários têm de aceitar o aviso antes de o editor Cursive ser carregado. Não existe opção de recusa: quem não aceitar terá de escolher outro editor de texto nas suas preferências, pelo que deve manter pelo menos outro editor ativado. Ativar esta opção no meio do período bloqueia de imediato todos os usuários existentes. O consentimento em si, as retiradas, as oposições e as questões sobre menores de 18 anos são tratados pela sua instituição, não pela Cursive. Consulte o <a href="{$a->reporturl}">relatório de aceitações</a> para saber quem aceitou e quem não aceitou.';
$string['notice_error'] = 'Não foi possível registrar a sua aceitação. Tente novamente.';
$string['notice_existingcontent'] = 'O seu texto existente (só de leitura até aceitar o aviso)';
$string['notice_gate_heading'] = 'Aviso sobre a coleta de dados';
$string['notice_heading'] = 'Aviso de transparência de dados';
$string['notice_heading_desc'] = 'Exige que os usuários aceitom um aviso fixo sobre a coleta de dados do processo de escrita e de dados biométricos (digitação) antes de o editor Cursive ser carregado. Cada aceitação é registrada com a data e o texto exato apresentado. O texto está traduzido e não pode ser editado aqui.';
$string['notice_nofallback_warning'] = 'O Cursive é o único editor de texto ativado neste site, pelo que os usuários que não aceitarem o aviso não poderão introduzir trabalhos escritos em lugar nenhum. Ative outro editor em <a href="{$a->manageurl}">Gerenciar editores</a> ou deixe o bloqueio desativado. O <a href="{$a->reporturl}">relatório de aceitações</a> mostra quem é afetado.';
$string['notice_para1'] = 'O Cursive coleta dados sobre o seu estilo de escrita e sobre a forma como planeja e redige os seus trabalhos escritos. Estes dados podem incluir dados biométricos (incluindo informação de análise de digitação) que a sua instituição de ensino utiliza para verificar que o trabalho que entrega foi redigido por você.';
...
$string['notice_para3'] = 'Encontra mais informação sobre o tratamento dos seus dados pessoais no <a href="{$a->privacyurl}" target="_blank" rel="noopener">aviso de privacidade da sua instituição <span class="sr-only visually-hidden">(abre em uma nova janela)</span></a>.';
...
$string['notice_recorded'] = 'A sua aceitação foi registrada. O Cursive está agora ativo neste editor.';
$string['notice_report'] = 'Aceitações do aviso do Cursive';
$string['notice_report_acknowledged'] = 'Usuários que aceitaram o aviso';
$string['notice_report_acknowledgedon'] = 'Aceito em';
...
$string['notice_report_datefrom'] = 'Aceito desde';
$string['notice_report_dateto'] = 'Aceito até';
$string['notice_report_disabled'] = 'O bloqueio por aviso está atualmente desativado. Os registros de aceitação existentes são mantidos e apresentados abaixo.';
...
$string['notice_report_pending'] = 'Usuários que ainda não aceitaram o aviso';
$string['notice_report_pendingcaption'] = 'Usuários no âmbito selecionado que não aceitaram a versão {$a} do aviso';
$string['notice_report_scoperequired'] = 'Selecione um curso ou uma coorte para listar os usuários que ainda não aceitaram o aviso atual.';
...
$string['notice_report_wording_superseded'] = 'Este texto já não corresponde à versão atual para este idioma. Os usuários que o aceitaram não voltam a ser solicitados.';
$string['notice_retentionperiod'] = 'Período de retenção das aceitações';
$string['notice_retentionperiod_default'] = 'Padrão: manter indefinidamente';
$string['notice_retentionperiod_desc'] = 'Durante quanto tempo os registros de aceitação são mantidos. 0 os mantém indefinidamente, o que é recomendado: são a sua prova de que os usuários foram informados, e os pedidos de apagamento nunca os removem. Caso contrário, uma tarefa diária elimina permanentemente os registros mais antigos e os textos a que nenhum registro faz referência.';
...
$string['privacy:metadata:database:tiny_cursive_notice'] = 'Registro apenas de adição que atesta que um usuário viu e aceitou o aviso de transparência de dados. Estes registros são mantidos perante pedidos de apagamento: são a prova da instituição de que o tratamento foi devidamente notificado (art. 17.º, n.º 3, alíneas b) e e) do RGPD) e são mantidos indefinidamente, salvo se o administrador definir um período de retenção.';
$string['privacy:metadata:database:tiny_cursive_notice:noticetexthash'] = 'SHA-256 do texto exato apresentado ao usuário.';
$string['privacy:metadata:database:tiny_cursive_notice:noticeversion'] = 'Versão do texto do aviso que foi aceito.';
$string['privacy:metadata:database:tiny_cursive_notice:timecreated'] = 'Quando o usuário aceitou o aviso.';
$string['privacy:metadata:database:tiny_cursive_notice:userid'] = 'O usuário que aceitou o aviso.';
$string['privacy:metadata:database:tiny_cursive_notice_text'] = 'Os diferentes textos do aviso de transparência de dados que os usuários aceitaram, para que cada aceitação possa ser associada ao texto apresentado. Não contém dados pessoais.';
...
$string['privacy:metadata:database:tiny_cursive_user_writing'] = 'Estatísticas de escrita derivadas dos dados de digitação de um usuário.';
$string['privacy:metadata:database:tiny_cursive_user_writing:file_id'] = 'O registro de dados de digitação do qual estas estatísticas foram derivadas.';
$string['privacy:metadata:database:tiny_cursive_user_writing:score'] = 'Pontuação de confiança de autoria retornada pela API do Cursive.';
$string['privacy:metadata:database:tiny_cursive_user_writing:total_time_seconds'] = 'Tempo que o usuário passou escrevendo.';
$string['privacy:metadata:database:tiny_cursive_user_writing:user_agent'] = 'Tipo de dispositivo em que o usuário escreveu.';
$string['privacy:metadata:database:tiny_cursive_user_writing:word_count'] = 'Número de palavras que o usuário escreveu.';
$string['privacy:metadata:database:tiny_cursive_writing_diff'] = 'Comparação entre o texto que um usuário escreveu e o texto que entregou.';
$string['privacy:metadata:database:tiny_cursive_writing_diff:file_id'] = 'O registro de dados de digitação para o qual a comparação foi feita.';
$string['privacy:metadata:database:tiny_cursive_writing_diff:reconstructed_text'] = 'Texto reconstruído a partir da digitação do usuário.';
$string['privacy:metadata:database:tiny_cursive_writing_diff:submitted_text'] = 'Texto que o usuário entregou.';
$string['privacy:metadata:preference:tiny_cursive_noticeversion'] = 'A versão do aviso de transparência de dados que o usuário aceitou (uma cache do registro de aceitações).';
$string['privacy:metadata:preference:tiny_cursive_showguidance'] = 'Se o usuário optou por mostrar dicas de interpretação nas janelas de análise.';
...
$string['showguidance_help'] = 'Exibir dicas de interpretação abaixo de cada métrica. Esta preferência é salva e se aplica a todos os pop-ups de analítica.';
...
$string['words_per_minute_guidance'] = 'Velocidades consistentes acima de 100 WPM (ou bem acima da velocidade média de escrita anterior do aluno); a transcrição de texto existente costuma ser 40-60% mais rápida do que a escrita original.';
$string['wpm'] = 'WPM';
